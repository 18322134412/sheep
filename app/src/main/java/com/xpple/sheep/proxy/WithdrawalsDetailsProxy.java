...
public class WithdrawalsDetailsProxy {
...
//        queryMap.put("where", where);//{"playerName":"Jonathan Walsh"}
        ...
        RxFactory.getPublicServiceInstance(null)
                .queryWithdrawalsDetails(queryMap)
...
//        queryMap.put("where", where);//{"playerName":"Jonathan Walsh"}
    ...
    public interface IQueryItemListener {
        void onQueryItemSuccess(List<WithdrawalsHistory> objects, boolean isUpdate);
    ...
    public interface IQueryMoreItemListener {
        void onQueryMoreItemSuccess(List<WithdrawalsHistory> objects);
