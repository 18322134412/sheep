...
public class OverageDetailsProxy {
...
//        queryMap.put("where", where);//{"playerName":"Jonathan Walsh"}
    ...
    public interface IQueryItemListener {
        void onQueryItemSuccess(List<OverageHistory> objects, boolean isUpdate);
    ...
    public interface IQueryMoreItemListener {
        void onQueryMoreItemSuccess(List<OverageHistory> objects);
