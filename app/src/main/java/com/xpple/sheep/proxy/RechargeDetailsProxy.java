...
public class RechargeDetailsProxy {
...
//        queryMap.put("where", where);//{"playerName":"Jonathan Walsh"}
    ...
    public interface IQueryItemListener {
        void onQueryItemSuccess(List<RechargeHistory> objects, boolean isUpdate);
    ...
    public interface IQueryMoreItemListener {
        void onQueryMoreItemSuccess(List<RechargeHistory> objects);
