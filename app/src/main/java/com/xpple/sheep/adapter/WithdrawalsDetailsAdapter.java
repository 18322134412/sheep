...
public class WithdrawalsDetailsAdapter extends BaseListAdapter<WithdrawalsHistory> {

    public WithdrawalsDetailsAdapter(Context context, List<WithdrawalsHistory> items) {
        super(context, items);
    }
    ...
    public View bindView(int position, View convertView, ViewGroup parent) {
        ...
        WithdrawalsHistory contract = getList().get(position);
