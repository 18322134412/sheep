...
public class RechargeDetailsAdapter extends BaseListAdapter<RechargeHistory> {

    public RechargeDetailsAdapter(Context context, List<RechargeHistory> items) {
        super(context, items);
    }
    ...
    public View bindView(int position, View convertView, ViewGroup parent) {
        ...
        RechargeHistory contract = getList().get(position);
