 ...
 * @author nEdAy
 */
public class LostPasswordActivity extends BaseActivity implements UserProxy.IPasswordListener {
    ...
    private void reset() {
        ...
        userProxy.resetUserPassword(phone, password, sms);
    }
