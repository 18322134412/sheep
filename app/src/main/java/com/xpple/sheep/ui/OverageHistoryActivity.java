 ...
 * @author nEdAy
 */
public class OverageHistoryActivity extends BaseListActivity implements OverageDetailsProxy.IQueryItemListener, OverageDetailsProxy.IQueryCountItemListener, OverageDetailsProxy.IQueryMoreItemListener {
    ...
    public int bindLayout() {
        return R.layout.activity_overage_history;
    }

    @Override
    public void initView(View view) {
        setTintManager();
        initTopBarForLeft("收支记录", "返回");
        initListView();
