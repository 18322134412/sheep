...
public class ItemFragmentLeftB extends BaseLazyFragment implements ItemProxy.IQueryItemListener, ItemProxy.IQueryCountItemListener, ItemProxy.IQueryMoreItemListener {
