...
public class WebShopActivity extends BaseActivity {
    ...
    public void setTitle(CharSequence title) {
        ...
        initTopBarForBoth(title.toString(), "返回", this::onBackClick, "积分明细", () ->
                getOperation().startActivity(CreditsHistoryActivity.class)
        );
    }
    ...
    CreditsListener creditsListener = new CreditsListener() {
        /**
         * 当点击登录
        ...
        public void onLocalRefresh(WebView mWebView, String credits) {
            ...
            //TODO:
//                activity.getOperation().showToast("触发本地刷新积分：" + credits);
        }
    };
