...
public class ItemFragmentLeftE extends BaseLazyFragment implements ItemProxy.IQueryItemListener, ItemProxy.IQueryCountItemListener, ItemProxy.IQueryMoreItemListener {
