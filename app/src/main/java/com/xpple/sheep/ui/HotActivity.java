 ...
 * @author nEdAy
 */
public class HotActivity extends BaseListActivity implements ItemProxy.IQueryItemListener, ItemProxy.IQueryCountItemListener, ItemProxy.IQueryMoreItemListener {
