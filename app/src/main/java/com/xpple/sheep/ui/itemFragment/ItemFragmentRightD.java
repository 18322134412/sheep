...
public class ItemFragmentRightD extends BaseLazyFragment implements ItemProxy.IQueryItemListener, ItemProxy.IQueryCountItemListener, ItemProxy.IQueryMoreItemListener {
