...
public class ItemFragmentLeftC extends BaseLazyFragment implements ItemProxy.IQueryItemListener, ItemProxy.IQueryCountItemListener, ItemProxy.IQueryMoreItemListener {
