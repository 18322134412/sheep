...
public class ShareDialog implements PlatformActionListener {
    ...
    public ShareDialog builder(String title, String text, String imageUrl, String url) {
        ...
        View view = LayoutInflater.from(mContext).inflate(
                R.layout.include_pop_six_icon, null);
        // 设置Dialog最小宽度为屏幕宽度
        view.setMinimumWidth(display.getWidth());
        // 获取自定义Dialog布局中的控件
        TextView tv_cancel = (TextView) view.findViewById(R.id.tv_cancel);
        TextView tv_copy = (TextView) view.findViewById(R.id.tv_copy);
        RelativeLayout wechat = (RelativeLayout) view.findViewById(R.id.wechat);
        ...
        RelativeLayout wechatf = (RelativeLayout) view.findViewById(R.id.wechatf);
        ...
        RelativeLayout qqzone = (RelativeLayout) view.findViewById(R.id.qqzone);
        ...
        RelativeLayout qq = (RelativeLayout) view.findViewById(R.id.qq);
        ...
        RelativeLayout sina = (RelativeLayout) view.findViewById(R.id.sina);
        ...
        RelativeLayout sms = (RelativeLayout) view.findViewById(R.id.sms);
        ...
        tv_copy.setOnClickListener(v -> {
            ClipboardManager mClipboardManager = (ClipboardManager) CustomApplication.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
